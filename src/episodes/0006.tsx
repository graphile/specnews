...
export const ep0006: EpisodeDetails = {
  ...
  transcript: (
    <Transcript>
      ...
      <Timestamp>
        [0:xx] Specifying an <Code>extensions</Code> property on requests
      </Timestamp>
      <J>
      ...
      <Timestamp>
        [4:xx] <Code>@defer</Code> and <Code>@stream</Code> is now Stage 2:
        Draft
      </Timestamp>
      <B>
      ...
      <B>
        ...
        and the “Expanding subtyping” RFC. These pull requests can be found in
        the main Spec repo (
        <a
      ...
      <B>
        ...
        runtime&mdahs;for example allowing for dropdowns to be generated by
      ...
      <B>
        The slides are linked in the podcast episode notes, they are designed to
        be readable without narration.
      </B>
      <J>
